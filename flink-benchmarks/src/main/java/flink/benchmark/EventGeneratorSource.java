...
public class EventGeneratorSource extends LoadGeneratorSource<String> {
  ...
  public EventGeneratorSource(int loadTargetHz, int timeSliceLengthMs,
      long totalEventsToGenerate) {
    super(loadTargetHz, timeSliceLengthMs, totalEventsToGenerate);
