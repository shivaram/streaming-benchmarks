...
public class GroupedProcessingTimeWindowExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final long numElements = 1000000;
...
//            .apply(new SummingWindowFunction())
        ...
        final long envStartTime = System.currentTimeMillis();
        env.execute();
        final long envEndTime = System.currentTimeMillis();
        System.out.println("Took " + (envEndTime-envStartTime) + " msecs for " + numElements * env.getParallelism() + " values");
    }
    ...
    public static class SummingWindowFunction implements WindowFunction<Tuple2<Long, Long>, Tuple2<Long, Long>, Long, Window> {
        ...
        public void apply(Long key, Window window, Iterable<Tuple2<Long, Long>> values, Collector<Tuple2<Long, Long>> out) {
            ...
            out.collect(new Tuple2<Long, Long>(key, sum));
        }
    }
